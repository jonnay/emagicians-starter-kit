...
** ÆＳÞＥTＩC 
    ...
    The current ÆＳÞＥTＩC still needs a lot of work.  It's much further ahead than a raw text export but nowhere near what I want.  [[mn:1][file:./assets/images/tome-quilt/grimoire.jpg]]
...
(concat "<div class=\"my-quilt\">\n"      
        (mapconcat (lambda (f)
                   ...
                   (directory-files "assets/images/tome-quilt"
                                    nil
