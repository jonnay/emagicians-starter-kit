...
*** TODO Sort out this micro-mess
**** TODO Find a better idiom for expressing emacs-lisp code wihtout initializing it
**** TODO starter-kit-packages needs to be quazi-dynamically generated. 
	 - emagician-invoke-package 
	   - same thing as code below, but not dependent on a sperate list
#+begin_src emacs-lisp
  (when nil 
