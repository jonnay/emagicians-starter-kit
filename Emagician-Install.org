...
#+begin_src emacs-lisp
(defvar emagician-dir
        "/home/jonny/emagicians-starter-kit/"
        "Automagically generated variable where the emagicians kit is located")
#+end_src
...
#+begin_src emacs-lisp :results silent
(find-file-other-window "./init.el")
#+end_src
...
#+results:
: `/home/jonny/.emacs.d/init.el' -> `~./.emacs.d/init-backup-2012-04-15_19-25-35.el'
: `./init.el' -> `/home/jonny/.emacs.d/init.el'
