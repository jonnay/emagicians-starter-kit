...
#+begin_src emacs-lisp 
(emagician/defhook unmap-visual-line-mode-keys visual-line-mode-hook  
...
(setq frame-title-format
      '(""
        ...
        (:eval (if (buffer-file-name)
                 ...
                 "%b"))
        (:eval (when (process-buffer (current-buffer))
                 (format "[%s}" (process-name (process-buffer (current-buffer))))))))
#+end_src
