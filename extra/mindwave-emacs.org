...
documentation, source-code and everything.  This is all part of a
"proof of concept" of being able to write and release elisp all inside
of an orgmode file.

** Load the files

   This chunk of code is handy for loading the elisp files.
...
* Changelog
  ...
  - v1.0 ::
	- rewrite of the hook API to be smarter in handling eSense, and eegPower
...
** Example five: A buffer displaying the current mindwave stats
