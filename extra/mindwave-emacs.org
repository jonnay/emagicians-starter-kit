...
#+begin_src emacs-lisp :tangle no
  (defvar 23-million-man/average-this-hour nil)
  
  (defun 23-million-man/running-average-hook (average-brain-ring)
    "Takes an AVERAGE-BRAIN-RING, and then updates the hourly average."
    (let ((total (+ (if 23-million-man/average-this-hour
                        (car 23-million-man/average-this-hour)
                      0)
                    1))
          (average (if 23-million-man/average-this-hour
                       (cdr 23-million-man/average-this-hour)
                     0)))
      (setq 23-million-man/average-this-hour 
            (cons total
                  (mindwave/brain-ring-apply '/ 
                                             (mindwave/brin-ring-apply '+  
                                                                       average
                                                                       average-brain-ring)
...
#+begin_src emacs-lisp :tangle no
  (defun 23-million-man/tbl-buffer-pos nil)
